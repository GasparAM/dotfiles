...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,  }, "Tab", function () awful.screen.focus_relative( 1) end,
              {description = "focus the next screen alt.", group = "screen"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume",  function ()    awful.util.spawn("pulseaudio-ctl up", false) end),
    awful.key({}, "XF86AudioLowerVolume",  function ()    awful.util.spawn("pulseaudio-ctl down", false) end),
